...
This is a Laravel 12 application built with Filament v4 for the admin panel, Livewire Volt for frontend interactivity, and Tailwind CSS v4 for styling. The application is in early development stages with Filament installed and configured at `/admin`.

## Development Commands

### Starting Development Environment
- `composer run dev` - Starts all services concurrently: Laravel server, queue worker, logs (Pail), and Vite
...
### Code Quality
- `vendor/bin/pint` - Format code according to project standards (always run before finalizing changes)
...
- Auto-discovers resources, pages, and widgets in their respective directories:
  - Resources: `app/Filament/Resources/`
  - Pages: `app/Filament/Pages/`
  - Widgets: `app/Filament/Widgets/`

### Frontend Architecture
- Livewire Volt is used for interactive components (class-based components)
- Views in `resources/views/`
- Volt components co-locate PHP logic and Blade templates in single files
- Tailwind CSS v4 for styling (uses `@import "tailwindcss"` syntax)
- Vite configuration in `vite.config.js`

### Laravel 12 Structure
- Uses streamlined Laravel 11+ structure
...
- Service providers in `app/Providers/` and registered in `bootstrap/providers.php`
...
- Currently only has home route (`/`) rendering welcome view

### Testing
- Pest v4 configured with browser testing support
...
## Environment
- Running on Laravel Herd (local development)
- PHP 8.3.26
